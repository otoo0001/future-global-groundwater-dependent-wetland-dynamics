...
#SBATCH --output=/path/to/WetGDEs_fgdw_v3/plots/figures_v2806/slurm/wtd_sensi_%A_%a.out
#SBATCH --error=/path/to/WetGDEs_fgdw_v3/plots/figures_v2806/slurm/wtd_sensi_%A_%a.err
#SBATCH --export=ALL
...
PYBIN="${PYBIN:-python}"
SCRIPT="/path/to/future_gdes_new_v2026/wtd_sensitivity.py"
...
LOGDIR="/path/to/WetGDEs_fgdw_v3/plots/figures_v2806/slurm"
mkdir -p "${LOGDIR}"
